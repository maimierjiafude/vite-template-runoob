...
- [ESLint@antfu风格](https://github.com/antfu/eslint-config)
  - 单引号
  - 无分号
  - 有自闭合标签 
...
[使用这个模板创建仓库](https://github.com/maimierjiafude/vite-template-runoob/generate).
...
[vitecamp](https://github.com/nekobc1998923/vitecamp) ❤